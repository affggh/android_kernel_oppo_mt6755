...
static void bad_page(struct page *page)
{
	...
	dump_stack();
#ifdef VENDOR_EDIT
//fangpan@Swdp.shanghai, 2016/05/13, remove this BUG, as free one free page
// should not trigger system bug, this is added by MTK
#else
	BUG();
#endif
out:
...
#ifdef VENDOR_EDIT
/* Huacai.Zhou@PSW.BSP.Kernel.MM, 2018-10-12, could not steal MIGRATE_OPPO*/
	if (unlikely(!page) && migratetype != MIGRATE_RESERVE &&
		migratetype != MIGRATE_OPPO0 && migratetype != MIGRATE_OPPO2) {
#else
	if (unlikely(!page) && migratetype != MIGRATE_RESERVE) {
#endif /*VENDOR_EDIT*/
...
#endif
#ifdef VENDOR_EDIT
/* Huacai.Zhou@PSW.BSP.Kernel.MM, 2018-10-12
...
again:
	if (likely(order == 0)) {
		...
		spin_lock_irqsave(&zone->lock, flags);
#ifdef VENDOR_EDIT
/* Huacai.Huacai@PSW.BSP.Kernel.MM, 2018-10-12
...
static void show_migration_types(unsigned char type)
{
	static const char types[MIGRATE_TYPES] = {
		...
		[MIGRATE_RESERVE]	= 'R',
#ifdef VENDOR_EDIT
/* Huacai.@PSW.BSP.Kernel.MM, 2017-8-21
...
#ifdef VENDOR_EDIT
/* Huacai.Zhou@PSW.BSP.Kernel.MM, 2018-10-15
